...
В связи с неполной рандомизированностью выходных значений хеш-функции от разных входных значений и/или малыми размерами массива для хранения данных, возникает явление коллизии. Это явление, при котором На рисунке видно 
